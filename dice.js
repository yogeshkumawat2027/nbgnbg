            ...
            if(shallowCopy[p1track].p2Buy == false && shallowCopy[p1track].p1Buy == false){
                if(AmountOfP1>shallowCopy[p1track].buyPrice){
                    ...
                    function Buy1(){
                        ...
                        document.querySelector(".player1-notice p").innerText = `Buy : -$${shallowCopy[p1track].buyPrice}`;
                        diceActivate2();
                        Activity2();
                    }
               ...
               setTimeout(()=>{
                    ...
                    document.querySelector(".player1-notice p").innerText = `Rent : -$${rentAmount}`;
                    document.querySelector(".player2-notice p").innerText = `Rent : +$${rentAmount}`;
                ...
                if(AmountOfP1<shallowCopy[p1track].sellPrice){     //when amount < ticket sell price
                    ...
                    function sell1(){
                        ...
                        // Calculate remaining amount
                         ...
                         //playSound
                        document.getElementById("buySound").play();
                        document.querySelector(".player1-notice p").innerText = ` Sell +$${shallowCopy[p1track].sellPrice}`;
                    }
                    ...
                    document.querySelector(".player1-notice p").innerText = ` Amount greater than +$${shallowCopy[p1track].sellPrice}`;
                    diceActivate2();
                    Activity2();
                }
            }
            ...
            if(shallowCopy[p2track].p1Buy == false && shallowCopy[p2track].p2Buy == false){
                ...
                //    });
                    function Buy2(){
                           ...
                           // Hide ticket and update visuals
                          setTimeout(()=>{
                             document.querySelector(".player2-notice p").innerText = `Buy : -$${shallowCopy[p2track].buyPrice}`;
                             document.getElementById("buySound").play();
                   ...
                   // buyBtn2.addEventListener("click",async()=>{     //works as sell btn
                    ...
                    function sell2(){
                            ...
                            // Calculate  amount
                             ...
                             //playSound
                            document.getElementById("buySound").play();
                            document.querySelector(".player2-notice p").innerText = `Sell : +$${shallowCopy[p2track].sellPrice}`;
                    }
                    ...
                    document.querySelector(".player2-notice p").innerText = `Amount greater than +$${shallowCopy[p2track].sellPrice}`;
                    diceActivate1();
                }
            }
